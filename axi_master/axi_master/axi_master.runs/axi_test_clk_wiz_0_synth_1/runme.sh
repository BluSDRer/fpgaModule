...
HD_PWD='C:/Users/jialf/Desktop/fpgaModule/axi_master/axi_master/axi_master.runs/axi_test_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_test_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_test_clk_wiz_0.tcl
